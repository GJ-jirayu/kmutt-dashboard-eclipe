...
<%
          ...
          //String query="call emp_by_in_out_year('CALENDAR_YEAR','2556','All','5')";
		  ...
		  String query="call emp_by_in_out_year('"+emp_paramTypeYear+"',"+emp_paramYear+",'"+emp_paramPos+"',"+emp_paramSize+")";

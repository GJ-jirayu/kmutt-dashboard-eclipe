...
<%
          ...
          //String query="call emp_by_study_edu_fac_a('CALENDAR_YEAR','2556','All','All')";
		  ...
		  String query="call emp_by_study_edu_fac_a('"+emp_paramTypeYear+"',"+emp_paramYear+",'"+emp_paramPos+"','"+emp_paramEdu+"')";

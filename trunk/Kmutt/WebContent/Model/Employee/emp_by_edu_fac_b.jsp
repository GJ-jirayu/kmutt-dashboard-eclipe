...
<%
          ...
          //String query="call emp_by_edu_fac_b('CALENDAR_YEAR','2556','All','All','5')"; 
		  ...
		  String query="call emp_by_edu_fac_b('"+emp_paramTypeYear+"',"+emp_paramYear+",'"+emp_paramPos+"','"+emp_paramTypeLine+"')";

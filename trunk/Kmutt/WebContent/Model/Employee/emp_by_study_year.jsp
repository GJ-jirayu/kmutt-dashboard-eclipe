...
<%
          ...
          //String query="call emp_by_study_year('CALENDAR_YEAR','2556','All','5')";
		  ...
		  String query="call emp_by_study_year('"+emp_paramTypeYear+"',"+emp_paramYear+",'"+emp_paramPos+"','"+emp_paramBou+"',"+emp_paramSize+")";

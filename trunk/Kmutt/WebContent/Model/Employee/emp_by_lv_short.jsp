...
<%
          ...
          //String query="call emp_by_lv_short('CALENDAR_YEAR','2556','1','104','All')"; 
		  ...
		  String query="call emp_by_lv_short('"+emp_paramTypeYear+"',"+emp_paramYear+",'"+emp_paramEmpTypeGroup+"','"+emp_paramEmpTypeLine+"','"+emp_paramDep+"')";

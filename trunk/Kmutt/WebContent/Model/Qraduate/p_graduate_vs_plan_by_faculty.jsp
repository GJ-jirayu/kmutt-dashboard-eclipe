...
<%
          ...
          //String query="call p_graduate_vs_plan_by_faculty(2556,'1','N','001')";
		  ...
		  String query="call p_graduate_vs_plan_by_faculty("+paramYear+",'"+paramSemesterGra+"','"+paramForeign+"','"+paramEduLevel+"')";

...
<%
          ...
          //String query="call fn_revenue_ratio_dep_code('2556','All','All','All')";
		  ...
		  String query="call fn_revenue_ratio_dep_code("+fn_paramYear+",'"+fn_paramArea+"','"+fn_paramOrg+"','"+fn_paramDep+"')";

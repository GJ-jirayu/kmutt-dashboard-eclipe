...
<%
          ...
          //String query="call fn_cost_ratio_exp_dep('2557','All','10700000','All')";
		 ...
		 String query="call fn_cost_ratio_exp_dep("+fn_paramYear+",'"+fn_paramArea+"','"+fn_paramOrg+"','"+fn_paramDep+"')";

...
<%
          ...
          //String query="call p_all_student_by_faculty_and_fee_type(2556,'1','001')";
		  ...
		  String query="call p_all_student_by_faculty_and_fee_type("+paramYear+",\'"+paramSemesterAll+"\','"+paramEduLevel+"')";

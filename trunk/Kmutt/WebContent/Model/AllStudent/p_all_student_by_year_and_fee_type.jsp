...
<%
          ...
          //String query="call p_all_student_by_year_and_fee_type(2556,'1','001','3')";
		  ...
		  String query="call p_all_student_by_year_and_fee_type("+paramYear+",\'"+paramSemesterAll+"\',\'"+paramEduLevel+"\',\'"+paramYearSub+"\')";
